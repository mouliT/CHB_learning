...
% ·· Level-1 intuition ·····················································
\begin{physbox}[Start here: the bucket-and-hose analogy]
Imagine trying to fill a bucket with a hose whose flow rate varies as a
sine wave.  During the positive half of the cycle, water flows in; during
the negative half, it is sucked back out.  Over a full cycle the net
water is exactly zero --- the bucket is perfectly balanced.

Now suppose instead of letting the flow rate glide all the way to zero at
the zero-crossing, you \emph{freeze} it at a small positive trickle for a
short window either side of the crossing.  Even that tiny trickle, held
for the duration of the window, adds net water.  The wider the window
(larger $\phic$), the more extra water you accumulate.

This is precisely what clamped modulation does.  The ``hose'' is the
cell's output voltage $v_i(t)$; the ``water'' is energy flowing into the
DC capacitor (or back to the source).  By \emph{not} letting $v_i$ cross
zero smoothly, the cell absorbs more energy per cycle --- without ever
changing its peak amplitude $M$.
\end{physbox}
