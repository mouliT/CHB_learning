...
\[
    ...
    = \ig \sum_{i=1}^{n} \Vdci{i}\Mi\sin(\omg t + \theta_i)
\]
...
Staircase summation of cell voltages also approximates a sinusoid naturally,
reducing output harmonics without a bulky filter.
